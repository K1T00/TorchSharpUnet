...
namespace Models.Utils
{
	...
	public class LossFunctions
	{
		...
		private static Tensor CalculateLossNonBinary(Tensor prediction, Tensor target)
		{
			...
			var loss = bceLoss * bceWeight + diceLoss * (1 - bceWeight);
		...
		private static Tensor CalculateLossNonBinary2(Tensor prediction, Tensor target)
		{
		...
		private static Tensor CalculateLossBinaryCase(Tensor prediction, Tensor target)
		{
